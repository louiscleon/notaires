...
async function handler(req, res) {
    ...
    try {
        ...
        const envState = {
            ...
            serviceAccountKeyLength: ((_a = process.env.GOOGLE_SERVICE_ACCOUNT_KEY) === null || _a === void 0 ? void 0 : _a.length) || 0,
            ...
            try {
                ...
                if (missingFields.length > 0) {
                    ...
                    serviceAccountInfo = {
                        ...
                        privateKeyLength: ((_b = serviceAccount.private_key) === null || _b === void 0 ? void 0 : _b.length) || 0,
